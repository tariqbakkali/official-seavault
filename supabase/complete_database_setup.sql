...
CREATE POLICY "Admins can insert categories" ON public.categories FOR INSERT WITH CHECK (false); -- Adjust as needed
CREATE POLICY "Admins can update categories" ON public.categories FOR UPDATE USING (false); -- Adjust as needed
CREATE POLICY "Admins can delete categories" ON public.categories FOR DELETE USING (false); -- Adjust as needed

-- Create policies for creatures
CREATE POLICY "Creatures are viewable by everyone" ON public.creatures FOR SELECT USING (true);
CREATE POLICY "Admins can insert creatures" ON public.creatures FOR INSERT WITH CHECK (false); -- Adjust as needed
CREATE POLICY "Admins can update creatures" ON public.creatures FOR UPDATE USING (false); -- Adjust as needed
CREATE POLICY "Admins can delete creatures" ON public.creatures FOR DELETE USING (false); -- Adjust as needed
...
CREATE POLICY "Admins can insert achievements" ON public.achievements FOR INSERT WITH CHECK (false); -- Adjust as needed
CREATE POLICY "Admins can update achievements" ON public.achievements FOR UPDATE USING (false); -- Adjust as needed
CREATE POLICY "Admins can delete achievements" ON public.achievements FOR DELETE USING (false); -- Adjust as needed

-- Create policies for user_achievements
CREATE POLICY "Users can view their own achievements" ON public.user_achievements FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "System can insert user achievements" ON public.user_achievements FOR INSERT WITH CHECK (true); -- Adjust as needed
CREATE POLICY "System can update user achievements" ON public.user_achievements FOR UPDATE USING (true); -- Adjust as needed
CREATE POLICY "System can delete user achievements" ON public.user_achievements FOR DELETE USING (true); -- Adjust as needed
